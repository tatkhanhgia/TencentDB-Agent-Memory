...
$DOCKER run -d --name "$CONTAINER" \
  ...
  -e CAPTURE_JOURNAL_DIR="${CAPTURE_JOURNAL_DIR:-/data/knowledge/capture}" \
  -e CAPTURE_JOURNAL_MAX_BYTES="${CAPTURE_JOURNAL_MAX_BYTES:-5242880}" \
  -e CAPTURE_INGEST_TOKEN="${CAPTURE_INGEST_TOKEN:-}" \
